...
public class PlaceHolder<K, V> {
    ...
    public static void main(String[] args) {
        ...
        PlaceHolder<Integer, Integer> ph6 = new PlaceHolder<Integer, Integer>(10, 10); //5
        PlaceHolder<Integer, Integer> ph7 = new PlaceHolder<>(10, 10); //5
        PlaceHolder<Integer, Integer> ph8 = new PlaceHolder(10, 10); //5
